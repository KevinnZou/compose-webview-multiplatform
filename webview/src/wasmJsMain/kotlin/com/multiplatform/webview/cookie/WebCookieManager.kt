...
actual fun getCookieExpirationDate(expiresDate: Long): String {
    return jsDateToUTCString(expiresDate)
}
 ...
 */
private fun setDocumentCookie(cookieStr: String) {
    setJsCookie(cookieStr)
}
 ...
 */
private fun getDocumentCookies(): String {
    return getJsCookies()
}
    ...
    override suspend fun setCookie(url: String, cookie: Cookie) {
        ...
        val cookieStr = buildString {
            ...
            cookie.expiresDate?.let { 
                append("; expires=${getCookieExpirationDate(it)}") 
            }
